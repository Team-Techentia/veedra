...
const ProductsPage = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      console.log('Failed to load products data');
    } finally {
      setLoading(false);
    }
  };
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className={`text-lg font-bold ${
                    (product.inventory?.currentStock || 0) > 10 ? 'text-green-600' : 
                    (product.inventory?.currentStock || 0) > 0 ? 'text-yellow-600' : 'text-red-600'
                  }`}>
