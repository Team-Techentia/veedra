    ...
    <div className="p-6 space-y-6">
      ...
      {showDetails && selectedBill && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg w-full max-w-sm max-h-[90vh] flex flex-col shadow-2xl">
            {/* Modal Header */}
            <div className="flex justify-between items-center px-4 py-3 border-b">
              <h2 className="text-lg font-bold">Bill {selectedBill.billNumber}</h2>
              <button
            ...
            {/* Receipt Preview — exactly what gets printed */}
            <div className="flex-1 overflow-hidden">
              <iframe
                srcDoc={generateReceiptHTML(selectedBill, false)}
